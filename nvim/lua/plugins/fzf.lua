...
--   keys = {
--     { "<C-space>", ":FzfLua buffers<CR>" },
--     { "<C-p>", ":FzfLua files<CR>" },
--     { "<leader>sg", ":FzfLua live_grep<CR>", desc = "[s]earch [g]rep" },
--     { "<leader>sw", ":FzfLua grep_cword<CR>", desc = "[s]earch [w]ord" },
--     { "<leader>sh", ":FzfLua helptags<CR>", desc = "[s]earch [h]elp" },
--     { "<leader>sc", ":FzfLua commands<CR>", desc = "[s]earch [c]ommands" },
--   },
-- }
